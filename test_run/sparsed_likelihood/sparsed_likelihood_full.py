...
all_parameters = bilby.gw.conversion.generate_all_bbh_parameters(parameters)

det.generate_FD_noise_realization_from_psd(seed=0)
det.inject_signal_FD(all_parameters, IMRPhenomD_h22_Amplitude_Phase_tf)
det.save_data()
...
priors = {}
priors['total_mass'] = bilby.core.prior.LogUniform(name='M', minimum=1e6, maximum=1e7)
priors['mass_ratio'] = bilby.core.prior.Uniform(name='q', minimum=0.1, maximum=1.0)
...
priors['luminosity_distance'] = bilby.core.prior.LogUniform(name='dist', minimum=10e3, maximum=100e3)
...
# RUN SAMPLER
outdir = 'outdir_pespace_sparsed_likelihood_full'
label = 'sparsed_likelihood_full'
