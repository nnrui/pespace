...
duration = 6*30*DAY_SI  # 6 month observation
cadence = 10
TDI_chans = ("A", "E")
TDI_gen = "1.5"
parameters = dict(
...
priors['coalescence_time'] = bilby.core.prior.Uniform(name='coalescence_time', minimum=-5*DAY_SI, maximum=5*DAY_SI)

priors['total_mass'] = bilby.core.prior.Uniform(name='total_mass', minimum=5e4, maximum=5e7)
priors['mass_ratio'] = bilby.core.prior.Uniform(name='mass_ratio', minimum=0.05, maximum=0.99)
priors['luminosity_distance'] = bilby.gw.prior.Uniform(name='luminosity_distance', minimum=500, maximum=50000)
