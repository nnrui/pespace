...
LDC_mbhb.set_frequency_domain_data_with_zero_value(channels=TDI_chans, 
                                               generation=TDI_gen, 
                                               duration=DAY_SI, 
                                               cadence=10)
LDC_mbhb.set_frequency_domain_noise_power_density_from_model("LISA_SciRDv1")
noise = LDC_mbhb.generate_realization_from_frequency_domain_noise_power_density()
LDC_mbhb.add_into_frequency_domian_data(noise)
