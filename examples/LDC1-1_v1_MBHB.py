...
dataname = "LDC1-1_MBHB_v1_1_TD_noiseless"
...
inj_mbhb = TDIChannelsData(label="inj-MBHB", minimum_frequency=1e-5, maximum_frequency=0.1)
inj_mbhb.set_frequency_domain_data_with_zero_value(channels=TDI_chans, 
                                                   generation=TDI_gen, 
                                                   duration=duration, 
                                                   cadence=cadence,)
