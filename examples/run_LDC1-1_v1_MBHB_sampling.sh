...
#SBATCH --output=/home/changfenggroup/nrui/works/codes/gw_space/pespace/examples/output/LDC1-1_v1_MBHB_sampling.out
...
mpiexec -n 80 python LDC1-1_v1_MBHB_sampling.py
